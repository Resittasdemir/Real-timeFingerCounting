...
while True:
    try:
        ...
        if dc == 1:
            if area_cnt < 2000:
                cv2.putText(frame, "Elini kutuya koy", (50, 50), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
            else:
                if area_ratio < 12:
                    cv2.putText(frame, "0", (0, 50), font, 2, (0, 0, 255), 2, cv2.LINE_AA)

                elif area_ratio < 17.5:
                    cv2.putText(frame, "iyi is", (0, 50), font, 2, (0, 0, 255), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, 'yeniden konumlandır', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)

        else:
            cv2.putText(frame, 'yeniden konumlandır', (10, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
